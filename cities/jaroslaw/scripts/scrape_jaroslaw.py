#!/usr/bin/env python3
"""Radoskop Jarosław — imienne głosowania Rady Miasta Jarosławia (IX kadencja).

Źródło: portal-posiedzenia.pl (System Posiedzenia), subdomena `miastojaroslaw`
(BIP bip.miastojaroslaw.pl -> PDF-y "WYKAZ GŁOSOWAŃ" generowane z tego systemu;
PDFy słabej jakości OCR -> dane brać z API chart portalu).

#!/usr/bin/env python3
"""Radoskop Opole Lubelskie — eSesja scraper (thin wrapper around scripts/lib_esesja.py).

Backend: https://opolelubelskie.esesja.pl (Rada Miejska w Opolu Lubelskim,
IX kadencja 2024-2029). Publikuje głosowania przez eSesja "Portal Mieszkańca"
instance pod slugiem `opolelubelskie` — serwerowo-renderowane sesje (PM-instance A,
...
if __name__ == "__main__":
    raise SystemExit(EsesjaScraper(
        base_url="https://opolelubelskie.esesja.pl",
        kadencje=KADENCJE,
        councilors=COUNCILORS,
    ).run_cli(prog_name="Radoskop Opole Lubelskie (https://opolelubelskie.esesja.pl)"))

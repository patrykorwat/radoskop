#!/usr/bin/env python3
"""
Radoskop Świętochłowice — eSesja scraper (thin wrapper around scripts/lib_esesja.py).
...
if __name__ == "__main__":
    ...
    ).run_cli(prog_name="Radoskop Świętochłowice (https://swietochlowice.esesja.pl)"))

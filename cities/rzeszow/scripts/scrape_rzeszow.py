#!/usr/bin/env python3
"""
Scraper sesji i głosowań Rady Miasta Rzeszów.

Status: STUB (TODO).
Custom BIP — własne parsowanie HTML/PDF.
BIP: https://bip.erzeszow.pl/
eSesja: brak.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Scraper Radoskop Rzeszów (stub)")
    ...
    print(f"[Rzeszów] stub scraper, writing empty payloads")

...
# -*- coding: utf-8 -*-
"""
Radoskop Żukowo — imienne głosowania Rady Miejskiej w Żukowie (AlfaTV "System Rada").

Źródło: https://rada.zukowo.pl/ (AlfaTV System Rada, IX kadencja 2024-2029).
...
Struktura:
  ...
  /sklad-rady/radny/{id}      -> nazwisko (kluby NIE publikowane u Żukowa)

34 sesje IX kadencji (2024-05 .. 2026-08), 16 radnych.
Adapter rada.zukowo.pl == rada.miastoturek.pl (ten sam platformowy szablon AlfaTV).

#!/usr/bin/env python3
"""
Scraper sesji i głosowań Rady Miasta Kielce.

Status: STUB (TODO).
eSesja platform — port logic from scrape_bialystok.py.
BIP: https://www.bip.kielce.eu/
eSesja: https://kielce.esesja.pl
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Scraper Radoskop Kielce (stub)")
    ...
    print(f"[Kielce] stub scraper, writing empty payloads")

#!/usr/bin/env python3
"""
Scraper sesji i głosowań Rady Miasta Bielsko-Biała.

Status: STUB (TODO).
Custom BIP — własne parsowanie HTML/PDF.
BIP: https://bip.bielsko-biala.pl/
eSesja: brak.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Scraper Radoskop Bielsko-Biała (stub)")
    ...
    print(f"[Bielsko-Biała] stub scraper, writing empty payloads")

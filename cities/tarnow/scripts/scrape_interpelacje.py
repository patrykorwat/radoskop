#!/usr/bin/env python3
"""Scraper interpelacji i zapytań radnych Rady Miejskiej w Tarnowie (IX kad. 2024-2029).

Źródło: eSesja (https://tarnow.esesja.pl) — moduł "Interpelacje i zapytania".

    https://tarnow.esesja.pl/interpelacje_i_zapytania/{page}
...
def main() -> int:
    ...
    print("=== Interpelacje — Tarnów (eSesja) ===")
    ...
    for it in items:
        ...
        cri = f"cri-tarnow-{idm.group(1)}" if idm else f"cri-tarnow-{len(records)}"

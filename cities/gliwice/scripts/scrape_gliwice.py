#!/usr/bin/env python3
"""
Scraper sesji i głosowań Rady Miasta Gliwice.

Status: STUB (TODO).
Custom BIP — własne parsowanie HTML/PDF.
BIP: https://bip.gliwice.eu/
eSesja: brak.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Scraper Radoskop Gliwice (stub)")
    ...
    print(f"[Gliwice] stub scraper, writing empty payloads")

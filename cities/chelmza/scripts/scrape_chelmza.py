#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Radoskop Chełmża — imienne głosowania Rady Miejskiej (IX kadencja).

Źródło: portal-posiedzenia.pl (System Posiedzenia), subdomena `chelmza`
(BIP bip.chelmza.pl -> link 'Wykaz imiennych głosowań radnych').

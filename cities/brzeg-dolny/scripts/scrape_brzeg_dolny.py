#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Radoskop Brzeg Dolny — imienne głosowania Rady Miejskiej (IX kadencja).

Źródło: portal-posiedzenia.pl (System Posiedzenia), subdomena `brzegdolny`
(podmiot 1057, Urząd Miejski w Brzegu Dolnym).
...
def main():
    ...
    # ---- build (format jak chojnow/chojnow-lib_posiedzenia) ----

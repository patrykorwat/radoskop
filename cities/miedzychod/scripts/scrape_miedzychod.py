...
# -*- coding: utf-8 -*-
"""
Radoskop Turek — imienne głosowania Rady Miejskiej Turku (AlfaTV "System Rada").

Źródło: https://rada.miedzychod.pl/ (AlfaTV System Rada, IX kadencja 2024-2029).
...
29 sesji IX kadencji (I 2024-05-06 .. XXIX 2026-08-26), 21 radnych.

Użycie:
    python scrape_turek.py --city-dir cities/turek [--cache-dir .cache]
"""
        ...
        try:
            ...
            for dt in soup.find_all("dt"):
                if "Przynależność" in dt.get_text(" ", strip=True):
                    ...
                    break
            if name and "test" not in name.lower() and "przewodniczacy testowy" != name.lower():
...
def main():
    ...
    print(f"[miedzychod] total votes={output['kadencje'][0]['total_votes']} "

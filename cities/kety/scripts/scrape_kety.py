#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Radoskop kety — Tier-2 (roster / "model berliński") scraper.

Brak imiennych glosowań IX kadencji. Miasto dodawane jako Tier-2:
skład rady (roster). Rada Miejska w Kętach.

Źródło rosteru: eSesja Portal Mieszkańca kety.esesja.pl/posiedzenia (sekcja "Radni",
kadencja 2024-2029) — 21 radnych; profile /radny/{id}.
"""
import json
import re
import sys
...
KAD = "2024-2029"
NAMES = ["Grażyna Adamus", "Krystyna Baścik", "Wiesław Bertolin", "Magdalena Boba", "Seweryn Bryl", "Dariusz Gawęda", "Jakub Goc", "Tomasz Janeczko", "Tomasz Klęczar", "Maria Krawczyk", "Jan Kubik", "Dorota Kusak", "Lesław Kuźma", "Monika Matyszkowicz", "Agnieszka Mejza-Kanik", "Mariusz Naglik", "Olga Onyszkiewicz", "Iwona Piwowarska-Zaręba", "Łukasz Plewniak", "Paweł Puchała", "Grażyna Zajączek"]

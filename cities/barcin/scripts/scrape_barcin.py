...
# -*- coding: utf-8 -*-
"""
Radoskop Barcin — imienne głosowania Rady Miejskiej w Miastku (AlfaTV "System Rada").

Źródło: https://rada.barcin.pl/ (AlfaTV System Rada, IX kadencja 2024-2029).
...
Adapter rada.barcin.pl == rada.miastoturek.pl (ten sam platformowy szablon AlfaTV).

Użycie:
    python scrape_barcin.py --city-dir cities/barcin [--cache-dir .cache]
"""
...
def _club_key(name, roster):
    # Barcin: System Rada nie publikuje klubów (Przynależność brak na stronach
...
def main():
    ...
    print(f"[barcin] total votes={output['kadencje'][0]['total_votes']} "

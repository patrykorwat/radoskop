#!/usr/bin/env python3
"""Radoskop Kościerzyna — imienne głosowania Rady Miasta Kościerzyny (IX kadencja).

Źródło: portal-posiedzenia.pl (System Posiedzenia), subdomena `koscierzyna`
(BIP bip.koscierzyna.gda.pl -> PDF-y "WYKAZ GŁOSOWAŃ" generowane z tego systemu;

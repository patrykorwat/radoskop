#!/usr/bin/env python3
"""
Scraper sesji i głosowań Rady Miasta Radom.

Status: STUB (TODO).
eSesja platform — port logic from scrape_bialystok.py.
BIP: https://www.bip.radom.pl/
eSesja: https://radom.esesja.pl
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Scraper Radoskop Radom (stub)")
    ...
    print(f"[Radom] stub scraper, writing empty payloads")

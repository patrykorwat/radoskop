#!/usr/bin/env python3
"""Radoskop Jędrzejów — eSesja scraper (thin wrapper around scripts/lib_esesja.py).

Backend: https://jedrzejow.esesja.pl (Rada Miejska w Jędrzejowie,
IX kadencja 2024-2029). Publikuje głosowania przez eSesja "Portal Mieszkańca"
instance pod slugiem `jedrzejow` — serwerowo-renderowane sesje (PM-instance A,

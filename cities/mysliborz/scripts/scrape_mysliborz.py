...
# -*- coding: utf-8 -*-
"""
Radoskop Myślibórz — imienne głosowania Rady Miejskiej w Myślibórzie (IX kadencja 2024-2029).

Źródło: AlfaTV "System Rada" dla Urzędu Miejskiego w Myślibórzie
(rada.mysliborz.pl, /glosowania → /glosowania/posiedzenie/{id}).
...
Użycie: python scrape_mysliborz.py --output docs/data.json --profiles docs/profiles.json
        [--cache-dir .cache]
"""
...
def main():
    ...
    k=output['kadencje'][0]
    print(f"[mysliborz] sesje: {k['total_sessions']}, glosowania: {k['total_votes']}, radni: {k['total_councilors']}")
    print(f"[mysliborz] walidacja agregatow: ok={validated['ok']} mismatch={validated['mismatch']} noagg={validated['noagg']} emptytable={validated['emptytable']}")

#!/usr/bin/env python3
"""
Radoskop Polanica-Zdrój — eSesja scraper (thin wrapper around scripts/lib_esesja.py).
...
if __name__ == "__main__":
    ...
    ).run_cli(prog_name="Radoskop Polanica-Zdrój (https://polanica-zdroj.esesja.pl)"))

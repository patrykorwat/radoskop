...
# -*- coding: utf-8 -*-
"""
Radoskop Miastko — imienne głosowania Rady Miejskiej w Miastku (AlfaTV "System Rada").

Źródło: https://rada.miastko.pl/ (AlfaTV System Rada, IX kadencja 2024-2029).
...
Adapter rada.miastko.pl == rada.miastoturek.pl (ten sam platformowy szablon AlfaTV).

Użycie:
    python scrape_miastko.py --city-dir cities/miastko [--cache-dir .cache]
"""
...
def _club_key(name, roster):
    # Miastko: System Rada nie publikuje klubów (Przynależność brak na stronach
...
def main():
    ...
    print(f"[miastko] total votes={output['kadencje'][0]['total_votes']} "

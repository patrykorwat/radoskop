...
Źródło: https://rada.miastko.pl/interpelacje — serwer-renderowana tabela
...
def main():
    ap = argparse.ArgumentParser(description="Scraper interpelacji — Turek (AlfaTV)")
    ...
    print(f"=== Interpelacje — Turek (AlfaTV) ===")

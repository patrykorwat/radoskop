#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Radoskop Brzeziny — imienne głosowania Rady Miasta (IX kadencja).

Źródło: portal-posiedzenia.pl (System Posiedzenia), subdomena `brzeziny`
(BIP bip.brzeziny.pl Rada Miasta -> link 'Nagrania sesji rady'
https://portal.posiedzenia.pl/brzeziny).
Adapter: radoskop/scripts/lib_posiedzenia_pl.py.
Głosowania jawne imienne per punkt sesji; partie/kluby z chart API.
BIP-E protokoły (PDF tekstowi) NIE zawierają tabel imiennych — portal
posiedzeń jest pełnym źródłem.
"""
import argparse
import json
import sys

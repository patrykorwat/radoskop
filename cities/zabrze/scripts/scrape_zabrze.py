#!/usr/bin/env python3
"""
Scraper sesji i głosowań Rady Miasta Zabrze.

Status: STUB (TODO).
Custom BIP — własne parsowanie HTML/PDF.
BIP: https://bip.um.zabrze.pl/
eSesja: brak.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Scraper Radoskop Zabrze (stub)")
    ...
    print(f"[Zabrze] stub scraper, writing empty payloads")

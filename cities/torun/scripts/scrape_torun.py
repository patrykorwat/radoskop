#!/usr/bin/env python3
"""
Scraper sesji i głosowań Rady Miasta Toruń.

Status: STUB (TODO).
Custom BIP — własne parsowanie HTML/PDF.
BIP: https://www.bip.torun.pl/
eSesja: brak.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Scraper Radoskop Toruń (stub)")
    ...
    print(f"[Toruń] stub scraper, writing empty payloads")

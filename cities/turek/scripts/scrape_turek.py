...
Źródło: https://rada.miastoturek.pl/ (AlfaTV System Rada, IX kadencja 2024-2029).
...
BASE = "https://rada.miastoturek.pl"
...
def _club_key(name, roster):
    ...
    if "razem dla turku" in cl or "razem" in cl:
        return "RDT"
    if "laczy nas turek" in cl or "łączy nas turek" in cl:
        return "LNT"

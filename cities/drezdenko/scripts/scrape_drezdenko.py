#!/usr/bin/env python3
"""Radoskop Drezdenko — eSesja scraper (thin wrapper around scripts/lib_esesja.py).

Skład rady + przypisania klubowe są wczytywane z config.json (sekcja
club_assignments). Format: {"Imię Nazwisko": "kod_klubu"}.

Backend: https://drezdenko.esesja.pl (Rada Miejska w Drezdenku, IX kadencja 2024-2029).
Dodane automatycznie w ramach ekspansji cities 2026-09-07.
"""
...
if __name__ == "__main__":
    raise SystemExit(EsesjaScraper(
        base_url="https://drezdenko.esesja.pl",
        kadencje=KADENCJE,
        councilors=COUNCILORS,
    ).run_cli(prog_name="Radoskop Drezdenko (https://drezdenko.esesja.pl)"))

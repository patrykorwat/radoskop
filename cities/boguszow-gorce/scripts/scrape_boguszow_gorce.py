#!/usr/bin/env python3
"""
Radoskop Boguszowie-Gorcach — eSesja scraper (thin wrapper around scripts/lib_esesja.py).

Skład rady + przypisania klubowe są wczytywane z config.json (sekcja
club_assignments). Format: {"Imię Nazwisko": "kod_klubu"}.

Backend: https://boguszow-gorce.esesja.pl (Rada Miasta Boguszowie-Gorcach, IX kadencja 2024-2029).
...
if __name__ == "__main__":
    raise SystemExit(EsesjaScraper(
        base_url="https://boguszow-gorce.esesja.pl",
        kadencje=KADENCJE,
        councilors=COUNCILORS,
    ).run_cli(prog_name="Radoskop Boguszowie-Gorcach (https://boguszow-gorce.esesja.pl)"))

#!/usr/bin/env python3
"""
Radoskop Boguszów-Gorce — eSesja scraper (thin wrapper around scripts/lib_esesja.py).
...
if __name__ == "__main__":
    ...
    ).run_cli(prog_name="Radoskop Boguszów-Gorce (https://boguszow-gorce.esesja.pl)"))

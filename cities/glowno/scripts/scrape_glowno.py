#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Radoskop Głowno — imienne głosowania Rady Miejskiej (IX kadencja).

Źródło: portal-posiedzenia.pl (System Posiedzenia), subdomena `glowno`
(BIP bip.glowno.pl -> link 'Wykaz imiennych głosowań radnych').

#!/usr/bin/env python3
"""
Radoskop Aleksandrów Kujawski — eSesja scraper (thin wrapper around scripts/lib_esesja.py).
...
if __name__ == "__main__":
    ...
    ).run_cli(prog_name="Radoskop Aleksandrów Kujawski (https://aleksandrow-kujawski.esesja.pl)"))

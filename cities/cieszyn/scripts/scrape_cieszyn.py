#!/usr/bin/env python3
"""Radoskop Cieszyn — eSesja scraper (thin wrapper around scripts/lib_esesja.py).

Backend: https://cieszynmiasto.esesja.pl (Rada Miejska Cieszyna, IX kadencja
2024-2029; old-template na hoście custom, imienne /glosowanie/).
...
if __name__ == "__main__":
    raise SystemExit(EsesjaScraper(
        base_url="https://cieszynmiasto.esesja.pl",
        kadencje=KADENCJE,
        councilors=COUNCILORS,
    ).run_cli(prog_name="Radoskop Cieszyn (https://cieszynmiasto.esesja.pl)"))

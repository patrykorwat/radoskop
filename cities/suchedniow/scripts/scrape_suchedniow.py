#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Radoskop suchedniow — Tier-2 (roster / "model berliński") scraper.

Brak imiennych glosowań IX kadencji. Miasto dodawane jako Tier-2:
skład rady (roster). Rada Miejska w Suchedniowie.

Źródło rosteru: suchedniow.pl/cms/15329/sklad_rady_miejskiej_20242029
"""
import json
import re
import sys
...
KAD = "2024-2029"
NAMES = ["Lidia Frątczak", "Marcin Pałac", "Anna Salwa", "Arkadiusz Pająk", "Marta Kornecka", "Waldemar Krogulec", "Jacek Uba", "Agnieszka Włodarczyk-Mazurek", "Anna Dulemba", "Marek Gałczyński", "Ewa Garbala", "Izabela Kowalik", "Szymon Lech", "Tomasz Maluszczak", "Dorota Miernik"]
...
def build(city_dir: Path) -> int:
    ...
    names = list(NAMES)
    print(f"  suchedniow roster: {len(names)}")
    kadencja = {

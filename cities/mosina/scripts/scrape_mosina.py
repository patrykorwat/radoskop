#!/usr/bin/env python3
"""Radoskop Mosina — eSesja scraper (thin wrapper around scripts/lib_esesja.py).

Backend: https://mosina.esesja.pl (Rada Miejska w Mosinie,
IX kadencja 2024-2029). Publikuje głosowania przez eSesja "Portal Mieszkańca"
instance pod slugiem `mosina` — serwerowo-renderowane sesje (PM-instance A,
...
if __name__ == "__main__":
    raise SystemExit(EsesjaScraper(
        base_url="https://mosina.esesja.pl",
        kadencje=KADENCJE,
        councilors=COUNCILORS,
    ).run_cli(prog_name="Radoskop Mosina (https://mosina.esesja.pl)"))

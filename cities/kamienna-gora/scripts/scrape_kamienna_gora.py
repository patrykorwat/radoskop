#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Radoskop Kamienna Góra — imienne głosowania Rady Miejskiej (IX kadencja).

Źródło: portal-posiedzenia.pl (System Posiedzenia), subdomena `miastokamiennagora`
(BIP bip.kamiennagora.pl kategoria 'Głosowania radnych na Sesjach Rady Miasta'
linkuje miastokamiennagora.posiedzenia.pl?action=glosowania&cadency=2024).

#!/usr/bin/env python3
"""
Radoskop Sosnowiec — eSesja scraper (thin wrapper around scripts/lib_esesja.py).

Council members + club assignments są wczytywane z config.json (sekcja
club_assignments). Format: {"Imię Nazwisko": "kod_klubu"}.

Backend: https://sosnowiec.esesja.pl/ (Rada Miejska w Sosnowcu, IX kadencja
2024-2029, 25 radnych). Rozkład: KPL 17, PiS 6, TD 1, DzS 1.
"""
...
if __name__ == "__main__":
    raise SystemExit(EsesjaScraper(
        base_url="https://sosnowiec.esesja.pl",
        kadencje=KADENCJE,
        councilors=COUNCILORS,
    ).run_cli(prog_name="Radoskop Sosnowiec (https://sosnowiec.esesja.pl)"))

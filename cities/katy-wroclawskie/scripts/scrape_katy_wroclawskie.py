#!/usr/bin/env python3
"""Radoskop Kąty Wrocławskie — eSesja scraper (thin wrapper around scripts/lib_esesja.py).

Backend: https://katywroclawskie.esesja.pl (Rada Miejska w Kątach Wrocławskich,
...
Dodane 2026-08-31 (cron do 500 miast).
"""
...
if __name__ == "__main__":
    raise SystemExit(EsesjaScraper(
        base_url="https://katywroclawskie.esesja.pl",
        kadencje=KADENCJE,
        councilors=COUNCILORS,
    ).run_cli(prog_name="Radoskop Kąty Wrocławskie (https://katywroclawskie.esesja.pl)"))

#!/usr/bin/env python3
"""Radoskop Mińsk Mazowiecki — eSesja scraper (thin wrapper around scripts/lib_esesja.py).

Backend: https://minsk.esesja.pl (Rada Miasta w Mińsku Mazowieckim, IX kadencja
...
Dodane 2026-09-03 (cron do 500 miast).
"""
...
if __name__ == "__main__":
    raise SystemExit(EsesjaScraper(
        base_url="https://minsk.esesja.pl",
        kadencje=KADENCJE,
        councilors=COUNCILORS,
    ).run_cli(prog_name="Radoskop Mińsk Mazowiecki (https://minsk.esesja.pl)"))

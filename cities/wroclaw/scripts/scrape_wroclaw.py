...
def _fetch_paginated(base_url: str) -> list[dict]:
    ...
    na początku listy. Strony 2+ są historyczne (starsze sesje nie zmieniają
    swojego miejsca w indeksie) i mogą być cachowane, co eliminuje dziesiątki
    zbędnych HTTP requests przy każdym uruchomieniu pipeline'u.
    """
    sessions = []
    visited = set()

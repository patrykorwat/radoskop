#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Radoskop Chojnów — imienne głosowania Rady Miejskiej (IX kadencja).

Źródło: portal-posiedzenia.pl (System Posiedzenia), subdomena `chojnow`
(BIP bip.chojnow.net.pl -> link 'Imienne wykazy głosowań radnych').
